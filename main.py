...
app = Flask('__name__')
app.config['SECRET_KEY'] = "dszfghjesr234567uixdcfghj53we4rtyg"
...
#     aws_access_key_id= 'AKIAVLZQTXNY3RRBIAVA',
#     aws_secret_access_key='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'
# )
#
#
...
# s3 = S3FileSystem()
# bucket = 's3://dteamer-bucket'

# s3_bucket = s3.Bucket("dteamer-bucket")
# dir = "DT"
...
#     response = s3.list_objects(Bucket=_BUCKET_NAME, Prefix=_PREFIX)
